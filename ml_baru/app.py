...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://127.0.0.1:5173", "http://localhost:3000", "http://localhost:3001", "http://localhost:3003", "*"],
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"]
)

# Mount rekomendasi endpoint on main app
@app.post("/predict-rekomendasi")
async def predict_rekomendasi_proxy(data: RekomendasiBalitaData):
