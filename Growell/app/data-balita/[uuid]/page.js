                                    ...
                                    <div className="flex flex-col gap-6">
                                        {(() => {
                                            ...
                                            return (
                                                <>
                                                    <div>
                                                        <h4 className="text-xs font-bold text-gray-700 uppercase tracking-wide mb-3">Proyeksi Berat Badan</h4>
                                                            ...
                                                            <div className="min-w-[500px] h-[260px]">
                                                                <ResponsiveContainer width="100%" height="100%">
                                                                    <LineChart data={chartData} margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
                                                                        ...
                                                                        <YAxis stroke="#14b8a6" fontSize={12} tickFormatter={(val) => `${val}kg`} width={40} />
                                                    ...
                                                    <div>
                                                        <h4 className="text-xs font-bold text-gray-700 uppercase tracking-wide mb-3">Proyeksi Tinggi Badan</h4>
                                                        <div className="w-full overflow-x-auto pb-2">
                                                            <div className="min-w-[500px] h-[260px]">
                                                                <ResponsiveContainer width="100%" height="100%">
                                                                    <LineChart data={chartData} margin={{ top: 20, right: 30, left: 0, bottom: 5 }}>
                                                                        <CartesianGrid strokeDasharray="3 3" stroke="#f1f5f9" vertical={false} />
                                                                        <XAxis dataKey="tanggal_pengukuran" tickFormatter={formatDate} stroke="#94a3b8" fontSize={12} tickMargin={10} />
                                                                        <YAxis stroke="#6366f1" fontSize={12} tickFormatter={(val) => `${val}cm`} width={40} />
                                                                        <Tooltip labelFormatter={formatDate} contentStyle={tooltipStyle} />
                                                                        <Legend wrapperStyle={{ paddingTop: '20px' }} />
